...
#include "Vstore_buffer.h"     // For This
...
VL_CTOR_IMP(Vstore_buffer) {
    Vstore_buffer__Syms* __restrict vlSymsp = __VlSymsp = new Vstore_buffer__Syms(this, name());
...
void Vstore_buffer::__Vconfigure(Vstore_buffer__Syms* vlSymsp, bool first) {
    if (0 && first) {}  // Prevent unused
    this->__VlSymsp = vlSymsp;
}

Vstore_buffer::~Vstore_buffer() {
...
void Vstore_buffer::eval() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vstore_buffer::eval\n"); );
    Vstore_buffer__Syms* __restrict vlSymsp = this->__VlSymsp;  // Setup global symbol table
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
#ifdef VL_DEBUG
    // Debug assertions
...
void Vstore_buffer::_eval_initial_loop(Vstore_buffer__Syms* __restrict vlSymsp) {
...
VL_INLINE_OPT void Vstore_buffer::_sequent__TOP__1(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_sequent__TOP__1\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /Users/yongqinwang/Purple_Jade/commit_stage/test/sb_test/../../store_buffer.sv:115
    if (vlTOPp->reset_i) {
...
void Vstore_buffer::_settle__TOP__2(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_settle__TOP__2\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->sb_issue_entry_num_o = vlTOPp->store_buffer__DOT__sb_alloc_pt;
					 ...
					 ? (((0U == 
						...
						& (((IData)(0x21U) 
						   ...
						   & ((IData)(0x21U) 
						      * (IData)(vlTOPp->store_buffer__DOT__sb_commit_pt)))))
					 : 0U));
    // ALWAYS at /Users/yongqinwang/Purple_Jade/commit_stage/test/sb_test/../../store_buffer.sv:100
    vlTOPp->store_buffer__DOT__address_match = 0U;
    vlTOPp->store_buffer__DOT__data_match = 0U;
	...
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & vlTOPp->store_buffer__DOT__sb_q[0U]);
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[2U] 
						     << 0x1fU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[1U] 
						       >> 1U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[3U] 
						     << 0x1eU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[2U] 
						       >> 2U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[4U] 
						     << 0x1dU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[3U] 
						       >> 3U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[5U] 
						     << 0x1cU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[4U] 
						       >> 4U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[6U] 
						     << 0x1bU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[5U] 
						       >> 5U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[7U] 
						     << 0x1aU) 
						    | (vlTOPp->store_buffer__DOT__sb_q[6U] 
						       >> 6U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[8U] 
						     << 0x19U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[7U] 
						       >> 7U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[9U] 
						     << 0x18U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[8U] 
						       >> 8U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xaU] 
						     << 0x17U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[9U] 
						       >> 9U)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xbU] 
						     << 0x16U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xaU] 
						       >> 0xaU)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xcU] 
						     << 0x15U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xbU] 
						       >> 0xbU)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xdU] 
						     << 0x14U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xcU] 
						       >> 0xcU)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xeU] 
						     << 0x13U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xdU] 
						       >> 0xdU)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0xfU] 
						     << 0x12U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xeU] 
						       >> 0xeU)));
    }
	...
	vlTOPp->store_buffer__DOT__address_match = 1U;
	vlTOPp->store_buffer__DOT__data_match = (0xffffU 
						 & ((vlTOPp->store_buffer__DOT__sb_q[0x10U] 
						     << 0x11U) 
						    | (vlTOPp->store_buffer__DOT__sb_q[0xfU] 
						       >> 0xfU)));
    }
    vlTOPp->sb_mem_v_o = ((IData)(vlTOPp->rob_sb_valid_i) 
			  & ((0x20fU >= (0x3ffU & ((IData)(0x20U) 
				...
				>> (0x1fU & ((IData)(0x20U) 
					     + ((IData)(0x21U) 
						* (IData)(vlTOPp->store_buffer__DOT__sb_commit_pt)))))));
    vlTOPp->sb_ld_pass_value_o = vlTOPp->store_buffer__DOT__data_match;
    vlTOPp->sb_ld_pass_valid_o = ((IData)(vlTOPp->store_buffer__DOT__address_match) 
				  & (~ (IData)(vlTOPp->rob_mispredict_i)));
    // ALWAYS at /Users/yongqinwang/Purple_Jade/commit_stage/test/sb_test/../../store_buffer.sv:52
...
VL_INLINE_OPT void Vstore_buffer::_combo__TOP__3(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_combo__TOP__3\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->sb_issue_ready_o = ((0U != (IData)(vlTOPp->store_buffer__DOT__sb_num)) 
				& (~ (IData)(vlTOPp->rob_mispredict_i)));
...
void Vstore_buffer::_eval(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_eval\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vstore_buffer::_eval_initial(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_eval_initial\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vstore_buffer::final() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::final\n"); );
    // Variables
    Vstore_buffer__Syms* __restrict vlSymsp = this->__VlSymsp;
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
}

void Vstore_buffer::_eval_settle(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_eval_settle\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
VL_INLINE_OPT QData Vstore_buffer::_change_request(Vstore_buffer__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_change_request\n"); );
    Vstore_buffer* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
...
#ifdef VL_DEBUG
void Vstore_buffer::_eval_debug_assertions() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_eval_debug_assertions\n"); );
    // Body
...
void Vstore_buffer::_ctor_var_reset() {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vstore_buffer::_ctor_var_reset\n"); );
    // Body
    ...
    store_buffer__DOT__data_match = VL_RAND_RESET_I(16);
