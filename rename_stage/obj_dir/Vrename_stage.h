...
VL_MODULE(Vrename_stage) {
  public:
    ...
    VL_IN8(rob_ready_i,0,0);
    VL_IN8(rob_num_i,5,0);
    VL_IN8(sb_num_i,3,0);
    VL_OUT8(rename_rob_v_o,0,0);
    VL_OUT8(rename_sb_v_o,0,0);
    VL_IN8(sb_st_clear_valid_i,0,0);
    VL_IN8(sb_st_clear_entry_i,3,0);
    VL_IN16(commit_rename_i,11,0);
    VL_OUTW(renamed_o,73,0,3);
    VL_IN64(decoded_i,56,0);
    VL_OUT64(rename_rob_o,60,0);
    ...
    VL_SIG8(rename_stage__DOT__sb_num_q,3,0);
    VL_SIG8(rename_stage__DOT__sb_num_n,3,0);
    VL_SIG8(rename_stage__DOT__prev_store_cleared,0,0);
    VL_SIG8(rename_stage__DOT__prev_store_cleared_n,0,0);
    VL_SIGW(rename_stage__DOT__renamed,73,0,3);
    VL_SIG64(rename_stage__DOT__rename_rob,60,0);
  ...
  public:
    static void _combo__TOP__2(Vrename_stage__Syms* __restrict vlSymsp);
  ...
  public:
    ...
    static void _settle__TOP__1(Vrename_stage__Syms* __restrict vlSymsp);
