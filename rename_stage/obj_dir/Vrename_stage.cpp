...
void Vrename_stage::_settle__TOP__1(Vrename_stage__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrename_stage::_settle__TOP__1\n"); );
    Vrename_stage* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->rename_stage__DOT__rename_rob = (VL_ULL(0xfffffffffffffff) 
    ...
    vlTOPp->rename_stage__DOT__renamed[0U] = ((0xffffdfffU 
						 ...
						 & ((IData)(
							    (vlTOPp->decoded_i 
							     >> 2U)) 
						    << 0xdU)));
    vlTOPp->rename_stage__DOT__renamed[0U] = ((0xffffe01fU 
					       & vlTOPp->rename_stage__DOT__renamed[0U]) 
					      | (0xffffffe0U 
						 & ((0x1800U 
						     & ((IData)(vlTOPp->decoded_i) 
							<< 0xbU)) 
						    | ((IData)(vlTOPp->rob_num_i) 
						       << 5U))));
    vlTOPp->rename_stage__DOT__rename_rob = ((VL_ULL(0x100007ffffffffff) 
					      & vlTOPp->rename_stage__DOT__rename_rob) 
					     | ((QData)((IData)(
								(0x1fffeU 
								 & ((IData)(
								    ...
								    << 1U)))) 
						<< 0x2bU));
    vlTOPp->rename_stage__DOT__rename_rob = ((VL_ULL(0x1ffff800000007ff) 
					      & vlTOPp->rename_stage__DOT__rename_rob) 
					     | ((QData)((IData)(
								((((4U 
								    == 
								 ...
								 | ((((4U 
									...
									& ((IData)(
									  ...
									  | ((((0U 
										...
										>> 1U)))))))))) 
						<< 0xbU));
    vlTOPp->rename_stage__DOT__rename_rob = ((VL_ULL(0x1ffffffffffffff0) 
					      & vlTOPp->rename_stage__DOT__rename_rob) 
					     | (IData)((IData)(
							       (0xfU 
								& (IData)(
    ...
    vlTOPp->rename_stage__DOT__rename_rob = ((VL_ULL(0x1ffffffffffff80f) 
					      & vlTOPp->rename_stage__DOT__rename_rob) 
					     | ((QData)((IData)(
								(0x7fU 
								 & ((0x6fU 
									...
									(0x1fU 
								     ...
								     : 0U)))) 
						<< 4U));
    // ALWAYS at /Users/yongqinwang/Purple_Jade/rename_stage/rename_stage.sv:165
    ...
    vlTOPp->rename_rob_v_o = ((IData)(vlTOPp->rename_decode_ready_o) 
			      & (IData)(vlTOPp->decoded_v_i));
    vlTOPp->renamed_v_o = ((IData)(vlTOPp->issue_rename_ready_i) 
			   & (IData)(vlTOPp->rename_rob_v_o));
    vlTOPp->rename_sb_v_o = ((IData)(vlTOPp->rename_rob_v_o) 
			     & (IData)((vlTOPp->rename_stage__DOT__rename_rob 
					>> 0xcU)));
    // ALWAYS at /Users/yongqinwang/Purple_Jade/rename_stage/rename_stage.sv:113
    ...
    vlTOPp->rename_stage__DOT__sb_num_n = ((IData)(vlTOPp->rename_sb_v_o)
					    ? (IData)(vlTOPp->sb_num_i)
					    : (IData)(vlTOPp->rename_stage__DOT__sb_num_q));
    vlTOPp->rename_stage__DOT__renamed[0U] = ((0xfffffff0U 
					       & vlTOPp->rename_stage__DOT__renamed[0U]) 
					      | ((IData)(vlTOPp->rename_sb_v_o)
						  ? (IData)(vlTOPp->sb_num_i)
						  : (IData)(vlTOPp->rename_stage__DOT__sb_num_q)));
    vlTOPp->rename_stage__DOT__prev_store_cleared_n 
	= ((IData)(vlTOPp->rename_sb_v_o) | ((~ ((IData)(vlTOPp->sb_st_clear_valid_i) 
						 & ((IData)(vlTOPp->sb_st_clear_entry_i) 
						    == (IData)(vlTOPp->rename_stage__DOT__sb_num_q)))) 
					     & (IData)(vlTOPp->rename_stage__DOT__prev_store_cleared)));
    vlTOPp->rename_stage__DOT__renamed[0U] = ((0xffffffefU 
					       & vlTOPp->rename_stage__DOT__renamed[0U]) 
					      | (0x10U 
						 & ((~ 
						     (((IData)(vlTOPp->rename_stage__DOT__prev_store_cleared_n) 
						       & (1U 
							  == 
							  (7U 
							   & (IData)(
							 ...
							 (7U 
							  & (IData)(
								    (vlTOPp->decoded_i 
								     >> 0xbU)))))) 
						    << 4U)));
    vlTOPp->renamed_o[0U] = vlTOPp->rename_stage__DOT__renamed[0U];
    vlTOPp->renamed_o[1U] = vlTOPp->rename_stage__DOT__renamed[1U];
    vlTOPp->renamed_o[2U] = vlTOPp->rename_stage__DOT__renamed[2U];
}

VL_INLINE_OPT void Vrename_stage::_combo__TOP__2(Vrename_stage__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vrename_stage::_combo__TOP__2\n"); );
    Vrename_stage* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->rename_stage__DOT__renamed[0U] = ((0x3fffU 
					       & vlTOPp->rename_stage__DOT__renamed[0U]) 
...
VL_INLINE_OPT void Vrename_stage::_sequent__TOP__3(Vrename_stage__Syms* __restrict vlSymsp) {
    ...
    Vrename_stage* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // ALWAYS at /Users/yongqinwang/Purple_Jade/rename_stage/rename_stage.sv:183
    if (vlTOPp->reset_i) {
	...
	vlTOPp->rename_stage__DOT__sb_num_q = 0U;
	vlTOPp->rename_stage__DOT__prev_store_cleared = 0U;
    } else {
	...
	vlTOPp->rename_stage__DOT__sb_num_q = vlTOPp->rename_stage__DOT__sb_num_n;
	vlTOPp->rename_stage__DOT__prev_store_cleared 
	    = vlTOPp->rename_stage__DOT__prev_store_cleared_n;
    }
    // ALWAYS at /Users/yongqinwang/Purple_Jade/rename_stage/rename_stage.sv:233
    if (vlTOPp->reset_i) {
    ...
    // ALWAYS at /Users/yongqinwang/Purple_Jade/rename_stage/rename_stage.sv:212
    if (vlTOPp->reset_i) {
...
void Vrename_stage::_eval_debug_assertions() {
    ...
    if (VL_UNLIKELY((rob_num_i & 0xc0U))) {
	Verilated::overWidthError("rob_num_i");}
    if (VL_UNLIKELY((sb_num_i & 0xf0U))) {
	Verilated::overWidthError("sb_num_i");}
    if (VL_UNLIKELY((sb_st_clear_valid_i & 0xfeU))) {
	Verilated::overWidthError("sb_st_clear_valid_i");}
    if (VL_UNLIKELY((sb_st_clear_entry_i & 0xf0U))) {
	Verilated::overWidthError("sb_st_clear_entry_i");}
}
#endif // VL_DEBUG
...
void Vrename_stage::_ctor_var_reset() {
    ...
    rob_num_i = VL_RAND_RESET_I(6);
    sb_num_i = VL_RAND_RESET_I(4);
    rename_rob_o = VL_RAND_RESET_Q(61);
    rename_rob_v_o = VL_RAND_RESET_I(1);
    rename_sb_v_o = VL_RAND_RESET_I(1);
    sb_st_clear_valid_i = VL_RAND_RESET_I(1);
    sb_st_clear_entry_i = VL_RAND_RESET_I(4);
    ...
    rename_stage__DOT__sb_num_q = VL_RAND_RESET_I(4);
    rename_stage__DOT__sb_num_n = VL_RAND_RESET_I(4);
    rename_stage__DOT__prev_store_cleared = VL_RAND_RESET_I(1);
    rename_stage__DOT__prev_store_cleared_n = VL_RAND_RESET_I(1);
