...
void Vrename_stage::traceInitThis__1(Vrename_stage__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declBus  (c+158,"rename_stage RONDOM",-1,31,0);
	vcdp->declBus  (c+159,"rename_stage a",-1,8,0);
	// Tracing: rename_stage i // Ignored: Verilator trace_off at /Users/yongqinwang/Purple_Jade/rename/rename_stage.sv:169
	// Tracing: rename_stage j // Ignored: Verilator trace_off at /Users/yongqinwang/Purple_Jade/rename/rename_stage.sv:190
	vcdp->declBus  (c+160,"$unit I_ROM_DEPTH_P",-1,31,0);
	vcdp->declBus  (c+161,"$unit WORD_SIZE_P",-1,31,0);
	vcdp->declBus  (c+162,"$unit NUM_FLAGS",-1,31,0);
	vcdp->declBus  (c+161,"$unit NUM_ARCH_REG",-1,31,0);
	vcdp->declBus  (c+163,"$unit NUM_ARCH_DEST_REG",-1,31,0);
	vcdp->declBus  (c+163,"$unit NUM_ARCH_SRC1_REG",-1,31,0);
	vcdp->declBus  (c+164,"$unit BRANCH_CC_NUM",-1,31,0);
	vcdp->declBus  (c+165,"$unit NUM_FU",-1,31,0);
	vcdp->declBus  (c+157,"$unit WIDTH_FU",-1,31,0);
	vcdp->declBus  (c+163,"$unit INSTRUCTION_OP_NUM",-1,31,0);
	vcdp->declBus  (c+166,"$unit DECODED_INSTRUCTION_WIDTH",-1,31,0);
	vcdp->declBus  (c+167,"$unit NUM_PHYS_REG",-1,31,0);
	vcdp->declBus  (c+168,"$unit RENAMED_INSTRUCTION_WIDTH",-1,31,0);
	vcdp->declBus  (c+169,"$unit ROB_ENTRY",-1,31,0);
	vcdp->declBus  (c+161,"$unit SB_ENTRY",-1,31,0);
	vcdp->declBus  (c+170,"$unit ROB_WIDTH",-1,31,0);
	vcdp->declBus  (c+171,"$unit STORE_BUFFER_WIDTH",-1,31,0);
	vcdp->declBus  (c+170,"$unit ISSUE_ENTRY_WIDTH",-1,31,0);
	vcdp->declBus  (c+172,"$unit CDB_SB_WIDTH",-1,31,0);
	vcdp->declBus  (c+173,"$unit CDB_WIDTH",-1,31,0);
	vcdp->declBus  (c+174,"$unit COMMIT_RENAME_WIDTH",-1,31,0);
    }
}
...
void Vrename_stage::traceFullThis__1(Vrename_stage__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullBus  (c+159,(0x1e8U),9);
	vcdp->fullBus  (c+160,(0x10000U),32);
	vcdp->fullBus  (c+161,(0x10U),32);
	vcdp->fullBus  (c+162,(4U),32);
	vcdp->fullBus  (c+163,(8U),32);
	vcdp->fullBus  (c+164,(0xfU),32);
	vcdp->fullBus  (c+165,(7U),32);
	vcdp->fullBus  (c+166,(0x39U),32);
	vcdp->fullBus  (c+167,(0x80U),32);
	vcdp->fullBus  (c+168,(0x4aU),32);
	vcdp->fullBus  (c+169,(0x40U),32);
	vcdp->fullBus  (c+170,(0x37U),32);
	vcdp->fullBus  (c+171,(0x21U),32);
	vcdp->fullBus  (c+172,(0x15U),32);
	vcdp->fullBus  (c+173,(0x2dU),32);
