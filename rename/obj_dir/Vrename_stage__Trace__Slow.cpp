...
void Vrename_stage::traceInitThis__1(Vrename_stage__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->declQuad (c+163,"rename_rob_o",-1,59,0);
	vcdp->declBit  (c+165,"rename_rob_v_o",-1);
	...
	vcdp->declQuad (c+163,"rename_stage rename_rob_o",-1,59,0);
	vcdp->declBit  (c+165,"rename_stage rename_rob_v_o",-1);
	vcdp->declQuad (c+150,"rename_stage decoded",-1,56,0);
	vcdp->declArray(c+1,"rename_stage renamed",-1,73,0);
	vcdp->declArray(c+75,"rename_stage renamed_r",-1,73,0);
	vcdp->declArray(c+166,"rename_stage renamed_n",-1,73,0);
	vcdp->declBus  (c+160,"rename_stage commit_entry",-1,11,0);
	vcdp->declQuad (c+169,"rename_stage rename_rob",-1,59,0);
	vcdp->declArray(c+4,"rename_stage lut_spec_n",-1,111,0);
	vcdp->declArray(c+78,"rename_stage lut_spec_q",-1,111,0);
	vcdp->declArray(c+8,"rename_stage fl_spec_n",-1,895,0);
	vcdp->declArray(c+82,"rename_stage fl_spec_q",-1,895,0);
	vcdp->declArray(c+36,"rename_stage lut_n",-1,111,0);
	vcdp->declArray(c+110,"rename_stage lut_q",-1,111,0);
	vcdp->declArray(c+40,"rename_stage fl_n",-1,895,0);
	vcdp->declArray(c+114,"rename_stage fl_q",-1,895,0);
	vcdp->declBus  (c+142,"rename_stage fl_read_pt",-1,6,0);
	vcdp->declBus  (c+143,"rename_stage fl_write_pt",-1,6,0);
	vcdp->declBus  (c+144,"rename_stage fl_spec_read_pt",-1,6,0);
	vcdp->declBus  (c+145,"rename_stage fl_spec_write_pt",-1,6,0);
	...
	vcdp->declBus  (c+146,"rename_stage fl_spec_num",-1,7,0);
	...
	vcdp->declBit  (c+74,"rename_stage renamed_v",-1);
	vcdp->declBit  (c+147,"rename_stage renamed_v_r",-1);
	// Tracing: rename_stage i // Ignored: Verilator trace_off at /Users/yongqinwang/Purple_Jade/rename/rename_stage.sv:179
	// Tracing: rename_stage j // Ignored: Verilator trace_off at /Users/yongqinwang/Purple_Jade/rename/rename_stage.sv:200
...
void Vrename_stage::traceFullThis__1(Vrename_stage__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
	...
	vcdp->fullBit  (c+74,(vlTOPp->rename_stage__DOT__renamed_v));
	vcdp->fullArray(c+75,(vlTOPp->rename_stage__DOT__renamed_r),74);
	vcdp->fullArray(c+78,(vlTOPp->rename_stage__DOT__lut_spec_q),112);
	vcdp->fullArray(c+82,(vlTOPp->rename_stage__DOT__fl_spec_q),896);
	vcdp->fullArray(c+110,(vlTOPp->rename_stage__DOT__lut_q),112);
	vcdp->fullArray(c+114,(vlTOPp->rename_stage__DOT__fl_q),896);
	vcdp->fullBus  (c+142,(vlTOPp->rename_stage__DOT__fl_read_pt),7);
	vcdp->fullBus  (c+143,(vlTOPp->rename_stage__DOT__fl_write_pt),7);
	vcdp->fullBus  (c+144,(vlTOPp->rename_stage__DOT__fl_spec_read_pt),7);
	vcdp->fullBus  (c+145,(vlTOPp->rename_stage__DOT__fl_spec_write_pt),7);
	vcdp->fullBus  (c+146,(vlTOPp->rename_stage__DOT__fl_spec_num),8);
	vcdp->fullBit  (c+147,(vlTOPp->rename_stage__DOT__renamed_v_r));
	...
	vcdp->fullQuad (c+163,(vlTOPp->rename_rob_o),60);
	vcdp->fullBit  (c+165,(vlTOPp->rename_rob_v_o));
	...
	vcdp->fullArray(c+166,(__Vtemp15),74);
	vcdp->fullQuad (c+169,(vlTOPp->rename_stage__DOT__rename_rob),60);
