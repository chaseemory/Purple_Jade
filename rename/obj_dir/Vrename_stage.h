...
VL_MODULE(Vrename_stage) {
  public:
    ...
    VL_SIG8(rename_stage__DOT__renamed_v,0,0);
    VL_SIG8(rename_stage__DOT__renamed_v_r,0,0);
    VL_SIGW(rename_stage__DOT__renamed,73,0,3);
    VL_SIGW(rename_stage__DOT__renamed_r,73,0,3);
    VL_SIGW(rename_stage__DOT__renamed_n,73,0,3);
    VL_SIG64(rename_stage__DOT__rename_rob,59,0);
